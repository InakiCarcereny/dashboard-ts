...
export function Earnings() {
  return (
    <div className="flex flex-col gap-2 h-[200px] w-full sm:w-full md-full lg-full xl:w-[600px] bg-zinc-300 dark:bg-zinc-700/40 rounded-xl dark:text-zinc-700/40 px-4 py-2">
